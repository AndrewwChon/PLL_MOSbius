...
T {Select B for PFD Mux is Polarity Switch} 2340 -3030 0 0 0.4 0.4 {}
T {Schmitt Trigger / Hysteresis Buffer} 1750 -3000 0 0 0.3 0.3 {}
T {Select A for External PFD} 2340 -3000 0 0 0.4 0.4 {}
T {Select A for External VCO} 4490 -3200 0 0 0.4 0.4 {}
...
T {Control for Programmable
Charge Pump. 1x, 2x, 4x, 8x} 4570 -3010 0 0 0.3 0.3 {}
T {Select B for Relaxation VCO} 4490 -3230 0 0 0.4 0.4 {}
T {Select C for Current Starved Ring VCO} 4490 -3260 0 0 0.4 0.4 {}
T {Select C for Normal Operation PFD} 2340 -3060 0 0 0.4 0.4 {}
...
N 4390 -2760 4420 -2760 {lab=csrvco_in}
N 4820 -2760 4850 -2760 {lab=#net1}
...
N 3480 -2200 3520 -2200 {lab=#net2}
...
N 3760 -2080 3820 -2080 {lab=div_def}
N 3680 -2180 3680 -2140 {lab=vdd}
N 3680 -2020 3680 -1980 {lab=vss}
N 3520 -2200 3520 -2080 {lab=#net2}
N 3520 -2080 3600 -2080 {lab=#net2}
N 4560 -2970 4560 -2920 {lab=#net9}
N 4580 -2970 4580 -2920 {lab=#net10}
N 4620 -2970 4620 -2930 {lab=#net11}
N 4580 -3160 4580 -3130 {lab=vdd}
N 4620 -3160 4620 -3130 {lab=vss}
N 4620 -2930 4620 -2920 {lab=#net11}
N 4640 -2970 4640 -2920 {lab=#net12}
N 4660 -3030 4700 -3030 {lab=#net13}
N 4660 -3070 4780 -3070 {lab=#net1}
N 4780 -3070 4780 -2760 {lab=#net1}
N 4780 -2760 4820 -2760 {lab=#net1}
N 4420 -2760 4460 -2760 {lab=csrvco_in}
N 4460 -3050 4460 -2770 {lab=csrvco_in}
N 4460 -3050 4540 -3050 {lab=csrvco_in}
N 4500 -3020 4540 -3020 {lab=#net14}
N 4500 -3000 4540 -3000 {lab=#net15}
N 4500 -3100 4540 -3100 {lab=#net16}
N 4460 -2770 4460 -2760 {lab=csrvco_in}
...
C {devices/iopin.sym} 3820 -2080 2 1 {name=p122 lab=div_def}
...
C {libs/core_analog/CSRVCO_20250823/CSRVCO_20250823.sym} 4620 -2720 0 0 {name=xvco_csr}
...
C {libs/core_analog/asc_hysteresis_buffer/asc_hysteresis_buffer.sym} 3680 -2080 0 1 {name=xbuf_dd}
C {lab_wire.sym} 3680 -1980 0 0 {name=p199 sig_type=std_logic lab=vss}
C {lab_wire.sym} 3680 -2160 0 0 {name=p200 sig_type=std_logic lab=vdd}
C {libs/qw_core_analog/VCOfinal/VCOfinal.sym} 4600 -3050 0 0 {name=xvco_rex}
C {noconn.sym} 4700 -3030 0 1 {name=l8}
C {lab_wire.sym} 4580 -3140 0 0 {name=p201 sig_type=std_logic lab=vdd}
C {lab_wire.sym} 4620 -3140 0 0 {name=p202 sig_type=std_logic lab=vss}
C {lab_wire.sym} 4460 -2760 0 0 {name=p203 sig_type=std_logic lab=rexvco_in}
C {lab_wire.sym} 4830 -2760 0 0 {name=p204 sig_type=std_logic lab=rexvco_out}
C {devices/iopin.sym} 1700 -2260 0 1 {name=p205 lab=rex_s1}
C {devices/iopin.sym} 1700 -2240 0 1 {name=p206 lab=rex_s2}
C {devices/iopin.sym} 1700 -2220 0 1 {name=p207 lab=rex_s3}
C {devices/iopin.sym} 1700 -2200 0 1 {name=p208 lab=rex_s4}
C {lab_wire.sym} 4560 -2920 0 0 {name=p209 sig_type=std_logic lab=rex_s1}
C {lab_wire.sym} 3510 -3160 0 0 {name=p210 sig_type=std_logic lab=200p2}
C {lab_wire.sym} 3510 -3120 0 0 {name=p211 sig_type=std_logic lab=200p1}
C {lab_wire.sym} 4530 -3100 0 0 {name=p212 sig_type=std_logic lab=200p1}
C {lab_wire.sym} 4530 -3020 0 0 {name=p213 sig_type=std_logic lab=200p2}
C {lab_wire.sym} 3510 -3080 0 0 {name=p214 sig_type=std_logic lab=200n}
C {lab_wire.sym} 4530 -3000 0 0 {name=p215 sig_type=std_logic lab=200n}
C {lab_wire.sym} 4700 -3030 0 0 {name=p216 sig_type=std_logic lab=rexvco_outb}
C {lab_wire.sym} 4580 -2930 0 0 {name=p217 sig_type=std_logic lab=rex_s2}
C {lab_wire.sym} 4620 -2940 0 0 {name=p218 sig_type=std_logic lab=rex_s3}
C {lab_wire.sym} 4640 -2950 0 0 {name=p219 sig_type=std_logic lab=rex_s4}
C {lab_wire.sym} 3540 -2080 0 0 {name=p220 sig_type=std_logic lab=int_div_def}
