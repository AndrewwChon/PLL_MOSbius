# Tcl script to run LVS on top_level_20250921
...
set circuit1 [readnet spice top_level_20250921_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice top_level_20250921.spice $circuit2

lvs "$circuit1 top_level_20250921" "$circuit2 top_level_20250921" \
        $setupfile top_level_20250921_comp.out
