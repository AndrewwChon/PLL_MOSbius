...
N 560 -680 660 -680 {lab=int_div_out}
...
N 3620 -440 3620 -300 {lab=int_div_in}
N 560 -680 560 -300 {lab=int_div_out}
N 1940 -580 1940 -560 {lab=div_prc_s0}
N 900 -300 900 -240 {lab=int_div_out}
N 3160 -300 3160 -240 {lab=int_div_in}
...
N 2500 -300 3620 -300 {lab=int_div_in}
N 1420 -300 1700 -300 {lab=int_div_out}
N 560 -300 1260 -300 {lab=int_div_out}
N 3680 -520 3720 -520 {lab=vdd}
N 3520 -520 3560 -520 {lab=vss}
N 2130 -780 2140 -780 {lab=down_post}
N 2340 -300 2500 -300 {lab=int_div_in}
N 1260 -300 1420 -300 {lab=int_div_out}
...
N 790 -980 820 -980 {lab=dff_pfd_ps_ref}
N 790 -700 820 -700 {lab=dff_pfd_ps_div}
N 1380 -980 1420 -980 {lab=dff_pfd_ps_up}
N 1380 -700 1420 -700 {lab=#net3}
N 1100 -560 1100 -520 {lab=vdd}
N 1100 -400 1100 -360 {lab=vss}
N 1200 -460 1260 -460 {lab=#net4}
N 620 -480 1000 -480 {lab=ref_buff}
N 620 -960 620 -480 {lab=ref_buff}
N 560 -440 1000 -440 {lab=int_div_out}
N 1340 -560 1340 -520 {lab=vdd}
N 1340 -400 1340 -360 {lab=vss}
N 1420 -460 1480 -460 {lab=lock}
N 1100 -1020 1100 -980 {lab=vdd}
N 1100 -860 1100 -820 {lab=vss}
N 1100 -980 1100 -960 {lab=vdd}
N 1100 -880 1100 -860 {lab=vss}
N 820 -700 900 -700 {lab=dff_pfd_ps_div}
N 900 -900 900 -700 {lab=dff_pfd_ps_div}
N 900 -900 1040 -900 {lab=dff_pfd_ps_div}
N 820 -980 1000 -980 {lab=dff_pfd_ps_ref}
N 1000 -980 1000 -940 {lab=dff_pfd_ps_ref}
N 1000 -940 1040 -940 {lab=dff_pfd_ps_ref}
N 1160 -900 1240 -900 {lab=dff_pfd_ps_up}
N 1240 -980 1240 -900 {lab=dff_pfd_ps_up}
N 1240 -980 1380 -980 {lab=dff_pfd_ps_up}
N 1160 -940 1200 -940 {lab=#net3}
N 1200 -940 1200 -800 {lab=#net3}
N 1200 -800 1340 -800 {lab=#net3}
N 1340 -800 1340 -700 {lab=#net3}
N 1340 -700 1380 -700 {lab=#net3}
...
C {devices/iopin.sym} 1480 -460 2 1 {name=p33 lab=lock}
...
C {libs/core_analog/asc_lock_detector_20250826/asc_lock_detector_20250826.sym} 1100 -460 0 0 {name=xlock}
C {lab_wire.sym} 1100 -360 0 0 {name=p65 sig_type=std_logic lab=vss}
C {lab_wire.sym} 1100 -540 0 0 {name=p67 sig_type=std_logic lab=vdd}
C {lab_wire.sym} 1340 -540 0 0 {name=p71 sig_type=std_logic lab=vdd}
C {lab_wire.sym} 1340 -360 0 0 {name=p129 sig_type=std_logic lab=vss}
C {libs/core_analog/asc_drive_buffer/asc_drive_buffer.sym} 1340 -460 0 0 {name=xbuf_lock}
