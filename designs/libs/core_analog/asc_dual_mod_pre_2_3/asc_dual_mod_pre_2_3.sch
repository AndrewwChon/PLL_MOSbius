...
C {devices/lab_wire.sym} 360 -200 0 0 {name=p11 sig_type=std_logic lab=vss}
...
C {libs/core_analog/asc_dff/asc_dff.sym} 1180 -300 0 0 {name=x4}
C {devices/lab_wire.sym} 1180 -380 0 0 {name=p12 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 1180 -200 0 0 {name=p13 sig_type=std_logic lab=vss}
