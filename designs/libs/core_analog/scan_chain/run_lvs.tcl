# Tcl script to run LVS on scan_chain
...
set circuit1 [readnet spice scan_chain_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice scan_chain.spice $circuit2

lvs "$circuit1 scan_chain" "$circuit2 scan_chain" \
        $setupfile scan_chain_comp.out
