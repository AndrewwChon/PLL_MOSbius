...
N 120 -440 960 -440 {lab=in}
N 120 -440 120 -260 {lab=in}
N 880 -180 1100 -180 {lab=vss}
N 880 -340 1100 -340 {lab=vdd}
N 960 -440 960 -280 {lab=in}
N 960 -280 1000 -280 {lab=in}
N 740 -240 1000 -240 {lab=#net3}
N 740 -260 740 -240 {lab=#net3}
...
C {devices/iopin.sym} 1260 -260 0 0 {name=p6 lab=out}
...
C {libs/core_analog/asc_OR/asc_OR.sym} 1100 -260 0 0 {name=x5}
