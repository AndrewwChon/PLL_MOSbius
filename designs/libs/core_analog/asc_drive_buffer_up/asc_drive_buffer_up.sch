...
N 540 -290 540 -230 {lab=#net2}
N 480 -320 500 -320 {lab=#net1}
N 480 -320 480 -200 {lab=#net1}
N 480 -200 500 -200 {lab=#net1}
N 540 -200 600 -200 {lab=vss}
N 540 -320 600 -320 {lab=vdd}
N 460 -260 480 -260 {lab=#net1}
N 540 -260 560 -260 {lab=#net2}
...
N 720 -290 720 -230 {lab=#net3}
N 660 -320 680 -320 {lab=#net2}
N 660 -320 660 -200 {lab=#net2}
N 660 -200 680 -200 {lab=#net2}
N 720 -200 780 -200 {lab=vss}
N 720 -320 780 -320 {lab=vdd}
N 640 -260 660 -260 {lab=#net2}
N 720 -260 740 -260 {lab=#net3}
...
N 560 -260 640 -260 {lab=#net2}
N 900 -290 900 -230 {lab=out}
N 840 -320 860 -320 {lab=#net3}
N 840 -320 840 -200 {lab=#net3}
N 840 -200 860 -200 {lab=#net3}
N 900 -200 960 -200 {lab=vss}
N 900 -320 960 -320 {lab=vdd}
N 900 -260 920 -260 {lab=out}
N 960 -200 960 -120 {lab=vss}
N 900 -170 900 -120 {lab=vss}
N 900 -120 960 -120 {lab=vss}
N 900 -400 900 -350 {lab=vdd}
N 900 -400 960 -400 {lab=vdd}
N 960 -400 960 -320 {lab=vdd}
N 780 -120 900 -120 {lab=vss}
N 780 -400 900 -400 {lab=vdd}
N 740 -260 840 -260 {lab=#net3}
N 360 -290 360 -230 {lab=#net1}
N 300 -320 320 -320 {lab=in}
N 300 -320 300 -200 {lab=in}
N 300 -200 320 -200 {lab=in}
N 360 -200 420 -200 {lab=vss}
N 360 -320 420 -320 {lab=vdd}
N 280 -260 300 -260 {lab=in}
N 360 -260 380 -260 {lab=#net1}
...
C {symbols/pfet_03v3.sym} 700 -320 0 0 {name=M5
L=0.5u
W=48.0u
nf=2
m=1
...
C {symbols/nfet_03v3.sym} 700 -200 0 0 {name=M6
L=0.5u
W=16.0u
nf=2
m=1
...
C {symbols/pfet_03v3.sym} 880 -320 0 0 {name=M7
L=0.5u
W=96.0u
nf=4
m=1
...
C {symbols/nfet_03v3.sym} 880 -200 0 0 {name=M8
L=0.5u
W=32.0u
nf=4
m=1
...
C {symbols/pfet_03v3.sym} 340 -320 0 0 {name=M9
L=0.5u
W=3.0u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 340 -200 0 0 {name=M10
L=0.5u
W=1.0u
nf=1
m=1
