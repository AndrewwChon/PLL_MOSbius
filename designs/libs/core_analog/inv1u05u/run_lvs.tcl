# Tcl script to run LVS on inv1u05u
...
set circuit1 [readnet spice inv1u05u_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice inv1u05u.spice $circuit2

lvs "$circuit1 inv1u05u" "$circuit2 inv1u05u" \
        $setupfile inv1u05u_comp.out
