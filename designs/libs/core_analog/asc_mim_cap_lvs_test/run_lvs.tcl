# Tcl script to run LVS on asc_mim_cap_lvs_test
...
set circuit1 [readnet spice asc_mim_cap_lvs_test_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice asc_mim_cap_lvs_test.spice $circuit2

lvs "$circuit1 asc_mim_cap_lvs_test" "$circuit2 asc_mim_cap_lvs_test" \
        $setupfile asc_mim_cap_lvs_test_comp.out
