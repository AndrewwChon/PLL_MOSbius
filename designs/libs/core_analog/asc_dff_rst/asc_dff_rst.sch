...
N 620 -500 620 -460 {lab=vdd}
N 620 -340 620 -300 {lab=vss}
N 520 -400 540 -400 {lab=clkb}
N 720 -400 760 -400 {lab=clka}
...
N 1900 -620 1900 -580 {lab=#net7}
C {libs/core_analog/inv1u05u/inv1u05u.sym} 1040 -680 0 0 {name=x1}
C {libs/core_analog/inv1u05u/inv1u05u.sym} 380 -400 0 0 {name=x2}
C {devices/iopin.sym} 280 -400 0 1 {name=p1 lab=clk}
C {devices/lab_wire.sym} 520 -400 0 0 {name=p5 sig_type=std_logic lab=clkb}
C {devices/iopin.sym} 280 -560 0 1 {name=p2 lab=vdd}
C {devices/iopin.sym} 280 -540 0 1 {name=p3 lab=vss}
C {devices/lab_wire.sym} 380 -480 0 0 {name=p4 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 380 -300 0 0 {name=p6 sig_type=std_logic lab=vss}
...
C {libs/core_analog/inv1u05u/inv1u05u.sym} 620 -400 0 0 {name=x10}
C {devices/lab_wire.sym} 620 -480 0 0 {name=p34 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 620 -300 0 0 {name=p35 sig_type=std_logic lab=vss}
C {devices/lab_wire.sym} 760 -400 0 0 {name=p36 sig_type=std_logic lab=clka}
