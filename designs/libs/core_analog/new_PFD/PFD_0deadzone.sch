...
N 540 30 580 30 {lab=VDD}
N 540 -40 540 -0 {lab=CLKref}
N 540 80 700 80 {lab=UP}
N 540 280 700 280 {lab=DOWN}
N 580 330 620 330 {lab=CLKref}
N 540 230 580 230 {lab=VDD}
N 580 130 620 130 {lab=CLKvco}
N 540 200 620 200 {lab=CLKvco}
N 520 330 520 380 {lab=VSS}
N 380 130 380 230 {lab=#net2}
N 300 180 380 180 {lab=#net2}
N 420 160 420 200 {lab=#net4}
N 420 180 500 180 {lab=#net4}
N 420 -20 420 100 {lab=VDD}
N 320 -20 420 -20 {lab=VDD}
N 420 130 440 130 {lab=VDD}
N 440 80 440 130 {lab=VDD}
N 420 80 440 80 {lab=VDD}
N 420 260 420 380 {lab=VSS}
N 420 230 440 230 {lab=VSS}
N 440 230 440 280 {lab=VSS}
N 420 280 440 280 {lab=VSS}
...
C {lab_wire.sym} 570 30 2 0 {name=p9 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 570 230 2 0 {name=p10 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 550 180 2 0 {name=p11 sig_type=std_logic lab=VSS}
...
C {symbols/nfet_03v3.sym} 560 130 0 1 {name=M7
L=0.28u
W=2u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 560 330 0 1 {name=M8
L=0.28u
W=2u
nf=1
m=1
...
C {symbols/pfet_03v3.sym} 520 30 0 0 {name=M5
L=0.28u
W=0.5u
nf=1
m=1
...
C {symbols/pfet_03v3.sym} 520 230 0 0 {name=M6
L=0.28u
W=0.5u
nf=1
m=1
...
C {symbols/pfet_03v3.sym} 400 130 0 0 {name=M9
L=0.28u
W=2u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 400 230 0 0 {name=M10
L=0.28u
W=1u
nf=1
m=1
