# Tcl script to run LVS on VCOfinal_noCP
...
set circuit1 [readnet spice VCOfinal_noCP_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice VCOfinal_noCP.spice $circuit2

lvs "$circuit1 VCOfinal_noCP" "$circuit2 VCOfinal_noCP" \
        $setupfile VCOfinal_noCP_comp.out
