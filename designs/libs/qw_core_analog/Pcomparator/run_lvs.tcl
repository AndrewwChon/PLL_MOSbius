# Tcl script to run LVS on Pcomparator
...
set circuit1 [readnet spice Pcomparator_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice Pcomparator.spice $circuit2

lvs "$circuit1 Pcomparator" "$circuit2 Pcomparator" \
        $setupfile Pcomparator_comp.out
