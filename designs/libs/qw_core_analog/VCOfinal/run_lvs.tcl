# Tcl script to run LVS on VCOfinal
...
set circuit1 [readnet spice VCOfinal_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice VCOfinal.spice $circuit2

lvs "$circuit1 VCOfinal" "$circuit2 VCOfinal" \
        $setupfile VCOfinal_comp.out
