# Tcl script to run LVS on PCP1248X
...
set circuit1 [readnet spice PCP1248X_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice PCP1248X.spice $circuit2

lvs "$circuit1 PCP1248X" "$circuit2 PCP1248X" \
        $setupfile PCP1248X_comp.out
