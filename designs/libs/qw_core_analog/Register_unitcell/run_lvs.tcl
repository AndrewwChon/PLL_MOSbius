# Tcl script to run LVS on Register_unitcell
...
set circuit1 [readnet spice Register_unitcell_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice Register_unitcell.spice $circuit2

lvs "$circuit1 Register_unitcell" "$circuit2 Register_unitcell" \
        $setupfile Register_unitcell_comp.out
