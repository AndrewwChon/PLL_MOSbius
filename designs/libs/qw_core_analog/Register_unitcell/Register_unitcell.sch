...
C {iopin.sym} 1420 -270 0 0 {name=p9 lab=out}
...
C {libs/qw_core_analog/DFF_2phase_1/DFF_2phase_1.sym} 750 -470 0 0 {name=x1}
C {switch_matrix_gf180mcu_9t5v0-main/libs/gf180mcu_fd_sc_mcu9t5v0_symbols-main/and2_1.sym} 1060 -360 0 0 {name=x2 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {switch_matrix_gf180mcu_9t5v0-main/libs/gf180mcu_fd_sc_mcu9t5v0_symbols-main/or2_1.sym} 1300 -270 2 1 {name=x10 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {switch_matrix_gf180mcu_9t5v0-main/libs/gf180mcu_fd_sc_mcu9t5v0_symbols-main/and2_1.sym} 1060 -180 0 0 {name=x3 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
