# Tcl script to run LVS on DECAP_SC
...
set circuit1 [readnet spice DECAP_SC_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice DECAP_SC.spice $circuit2

lvs "$circuit1 DECAP_SC" "$circuit2 DECAP_SC" \
        $setupfile DECAP_SC_comp.out
