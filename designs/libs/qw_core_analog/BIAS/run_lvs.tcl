...
set circuit1 [readnet spice BIAS_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice BIAS.spice $circuit2

lvs "$circuit1 BIAS" "$circuit2 BIAS" \
        $setupfile BIAS_comp.out
