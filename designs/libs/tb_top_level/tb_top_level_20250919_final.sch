...
P 4 1 1970 -500 {}
T {DEFAULT STATE:
Overall division ratio: N*P + S (N=2 fixed)
For P=400, S=200 -> expect division ratio of 1000} 590 -550 0 0 0.4 0.4 {}
...
N 1280 -1160 1280 -1140 {lab=#net3}
N 1300 -1160 1300 -1140 {lab=#net4}
N 1320 -1160 1320 -1140 {lab=#net5}
N 1340 -1160 1340 -1140 {lab=#net6}
...
N 1340 -400 1340 -390 {lab=#net7}
N 1340 -330 1340 -320 {lab=vssa}
N 1440 -480 1440 -420 {lab=tune}
N 1440 -360 1440 -320 {lab=vssa}
N 1340 -320 1440 -320 {lab=vssa}
N 920 -860 940 -860 {lab=#net8}
N 880 -760 940 -760 {lab=reference}
N 880 -820 880 -760 {lab=reference}
N 810 -820 880 -820 {lab=reference}
N 810 -820 810 -810 {lab=reference}
N 810 -750 810 -740 {lab=#net9}
...
.param Cj_filter = 50p
"}
C {lab_wire.sym} 880 -820 0 0 {name=p4 sig_type=std_logic lab=reference}
...
savecurrent=false}
C {devices/code_shown.sym} 240 -1270 0 0 {name=Models1 only_toplevel=false
...
"}
C {devices/code_shown.sym} 155 -768.75 0 0 {name=Simulation only_toplevel=false value="
.save v(tune) v(out) v(reference) v(up) v(down) v(lock)
.save v(div_in) v(div_out) v(def) v(biasn_cp)

.control
set filetype=raw
tran 1n 200u
write tb_top_level_20250919_final.raw
.endc
"}
...
device=resistor
m=1}
C {isource.sym} 910 -660 0 0 {name=I1 value=\{Iref_cp\}}
C {noconn.sym} 920 -880 1 0 {name=l12}
C {noconn.sym} 920 -860 1 0 {name=l13}
C {noconn.sym} 920 -840 1 0 {name=l14}
C {libs/top_level/top_level_20250919/top_level_20250919_final/top_level_20250919_final.sym} 1220 -860 0 0 {name=xtop}
