...
C {lab_wire.sym} 460 -380 0 0 {name=p2 sig_type=std_logic lab=clk}
C {lab_wire.sym} 1120 -400 0 0 {name=p3 sig_type=std_logic lab=data}
C {lab_wire.sym} 1120 -340 0 0 {name=p4 sig_type=std_logic lab=en}
C {devices/vsource.sym} 220 -100 0 0 {name=Vssa1 value=0 savecurrent=false}
C {devices/vsource.sym} 320 -100 0 0 {name=Vssa2 value=0 savecurrent=false}
C {devices/vsource.sym} 420 -100 0 0 {name=Vssa3 value=0 savecurrent=false}
...
C {noconn.sym} 1330 -360 0 1 {name=l7}
C {noconn.sym} 1760 -360 0 1 {name=l8}
C {noconn.sym} 2190 -360 0 1 {name=l9}
