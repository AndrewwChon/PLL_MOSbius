...
N 800 -800 810 -800 {lab=down2}
N 810 -800 820 -800 {lab=down2}
N 880 -160 960 -160 {lab=up2}
N 640 -160 720 -160 {lab=up1}
N 800 -260 800 -220 {lab=vdda}
N 800 -100 800 -60 {lab=vssa}
N 1750 -780 1760 -780 {lab=#net3}
N 1500 -800 1500 -760 {lab=vctrl}
N 1500 -760 1750 -760 {lab=vctrl}
N 1750 -820 1780 -820 {lab=vssa}
N 1750 -840 1780 -840 {lab=vssa}
N 1750 -860 1780 -860 {lab=vdda}
N 1750 -880 1880 -880 {lab=#net4}
N 1750 -940 1780 -940 {lab=vssa}
N 1750 -960 1780 -960 {lab=vdda}
N 1750 -900 1860 -900 {lab=#net5}
N 1750 -920 1840 -920 {lab=#net6}
N 1860 -940 1860 -900 {lab=#net5}
N 1880 -900 1880 -880 {lab=#net4}
N 1840 -980 1840 -920 {lab=#net6}
N 1840 -1080 1840 -1040 {lab=vssa}
N 1860 -1040 1860 -1000 {lab=vssa}
N 1880 -1000 1880 -960 {lab=vdda}
...
value="PULSE(0 3.3 0 100p 100p 50u 100u)"
savecurrent=false}
...
value="PULSE(0 3.3 0 100p 100p 50n 1)"
savecurrent=false}
...
C {devices/lab_wire.sym} 800 -800 0 0 {name=p52 sig_type=std_logic lab=down2}
...
C {devices/lab_wire.sym} 800 -760 0 0 {name=p58 sig_type=std_logic lab=up2}
...
"}
C {libs/qw_core_analog/VCO0831_noTG/VCO0831_noTG.sym} 1600 -860 0 0 {name=x4}
C {noconn.sym} 1760 -780 0 1 {name=l2}
C {devices/lab_wire.sym} 1780 -860 0 0 {name=p17 sig_type=std_logic lab=vdda}
C {devices/lab_wire.sym} 1780 -840 0 0 {name=p20 sig_type=std_logic lab=vssa}
C {devices/lab_wire.sym} 1780 -820 0 0 {name=p63 sig_type=std_logic lab=vssa}
C {devices/lab_wire.sym} 1780 -960 0 0 {name=p64 sig_type=std_logic lab=vdda}
C {devices/lab_wire.sym} 1780 -940 0 0 {name=p65 sig_type=std_logic lab=vssa}
C {devices/isource.sym} 1840 -1010 2 0 {name=I4 value=200u}
C {devices/lab_wire.sym} 1840 -1060 0 1 {name=p69 sig_type=std_logic lab=vssa}
C {devices/lab_wire.sym} 1860 -1020 0 1 {name=p70 sig_type=std_logic lab=vssa}
C {devices/isource.sym} 1880 -930 0 0 {name=I5 value=200u}
C {devices/lab_wire.sym} 1880 -980 0 1 {name=p71 sig_type=std_logic lab=vdda}
C {devices/isource.sym} 1860 -970 2 0 {name=I6 value=200u}
