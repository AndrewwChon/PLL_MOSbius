...
N 180 -680 200 -680 {lab=mc}
N 180 -620 200 -620 {lab=d2}
N 180 -640 200 -640 {lab=d1}
N 180 -600 200 -600 {lab=d3}
N 180 -560 200 -560 {lab=d5}
N 180 -580 200 -580 {lab=d4}
N 180 -540 200 -540 {lab=d6}
N 180 -500 200 -500 {lab=d8}
N 180 -520 200 -520 {lab=d7}
N 180 -480 200 -480 {lab=d9}
...
N 940 -620 980 -620 {lab=vss}
N 860 -760 860 -720 {lab=vdd}
N 760 -760 760 -720 {lab=a}
N 520 -580 560 -580 {lab=#net1}
...
C {devices/iopin.sym} 180 -680 0 1 {name=p4 lab=mc}
C {devices/iopin.sym} 180 -620 0 1 {name=p5 lab=d2}
C {devices/iopin.sym} 180 -640 0 1 {name=p7 lab=d1}
C {devices/iopin.sym} 180 -600 0 1 {name=p8 lab=d3}
C {devices/iopin.sym} 180 -560 0 1 {name=p9 lab=d5}
C {devices/iopin.sym} 180 -580 0 1 {name=p10 lab=d4}
C {devices/iopin.sym} 180 -540 0 1 {name=p11 lab=d6}
C {devices/iopin.sym} 180 -500 0 1 {name=p12 lab=d8}
C {devices/iopin.sym} 180 -520 0 1 {name=p13 lab=d7}
C {devices/iopin.sym} 180 -480 0 1 {name=p14 lab=d9}
...
C {devices/lab_wire.sym} 580 -580 0 0 {name=p28 sig_type=std_logic lab=rst}
