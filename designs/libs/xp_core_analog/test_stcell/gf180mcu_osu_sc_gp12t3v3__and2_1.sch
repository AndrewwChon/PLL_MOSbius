...
S {}
E {}
N 130 -350 130 -320 { lab=#net1}
N 270 -350 270 -320 { lab=#net2}
N 130 -260 130 -230 { lab=#net3}
N 130 -230 270 -230 { lab=#net3}
N 270 -260 270 -230 { lab=#net3}
N 200 -230 200 -210 { lab=#net3}
N 200 -150 200 -110 { lab=#net4}
N 200 -50 200 -20 { lab=#net5}
N 70 -290 90 -290 { lab=#net6}
N 220 -290 230 -290 { lab=#net7}
N 450 -230 510 -230 { lab=#net8}
N 130 -290 150 -290 { lab=#net9}
N 270 -290 290 -290 { lab=#net10}
N 200 -180 210 -180 { lab=GND}
N 200 -80 220 -80 { lab=#net11}
N 140 -180 160 -180 { lab=A}
N 140 -80 160 -80 { lab=#net12}
N 450 -240 450 -210 { lab=#net8}
N 370 -180 410 -180 { lab=#net3}
N 370 -260 370 -180 { lab=#net3}
N 370 -270 370 -260 { lab=#net3}
N 370 -270 410 -270 { lab=#net3}
N 270 -230 370 -230 { lab=#net3}
N 450 -350 450 -300 { lab=#net13}
N 450 -150 450 -130 { lab=GND}
N 450 -270 470 -270 { lab=#net14}
N 450 -180 470 -180 {lab=#net15}
...
C {devices/nmos4.sym} 180 -180 0 0 {name=M2 model=nfet_03p3 w=0.85u l=0.3u m=1}
...
C {devices/lab_wire.sym} 210 -180 2 0 {name=p6 sig_type=std_logic lab=GND}
C {lab_wire.sym} 220 -80 2 0 {name=l7 sig_type=std_logic lab=GND}
C {devices/lab_wire.sym} 140 -180 0 0 {name=p8 sig_type=std_logic lab=A}
C {lab_wire.sym} 140 -80 0 0 {name=l9 sig_type=std_logic lab=B}
C {devices/pmos4.sym} 430 -270 0 0 {name=M4 model=pfet_03p3 w=1.7u l=0.3u m=1}
...
C {devices/gnd.sym} 450 -130 0 0 {name=l12 lab=GND}
