...
N 560 400 560 430 {lab=down}
N 420 410 520 410 {lab=#net8}
N 520 30 520 120 {lab=#net6}
N 420 70 520 70 {lab=#net6}
N 560 60 560 90 {lab=up}
N 560 70 680 70 {lab=up}
N 560 410 680 410 {lab=down}
N 300 150 360 150 {lab=down}
N 360 150 360 540 {lab=down}
N 360 540 640 540 {lab=down}
N 640 410 640 540 {lab=down}
N 300 490 320 490 {lab=up}
N 320 -20 320 490 {lab=up}
N 320 -20 640 -20 {lab=up}
N 640 -20 640 70 {lab=up}
