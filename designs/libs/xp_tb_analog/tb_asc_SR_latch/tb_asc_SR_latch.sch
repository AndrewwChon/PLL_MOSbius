...
N 620 -140 620 -100 {lab=vssa}
N 480 -240 520 -240 {lab=va}
N 480 -200 520 -200 {lab=vb}
N 760 -240 780 -240 {lab=vout}
N 280 -80 280 -30 {lab=vssa}
N 280 -200 280 -140 {lab=vb}
N 740 -240 760 -240 {lab=vout}
N 520 -200 580 -200 {lab=vb}
N 520 -240 580 -240 {lab=va}
N 620 -160 620 -140 {lab=vssa}
N 620 -300 620 -280 {lab=vdda}
N 660 -240 740 -240 {lab=vout}
...
C {devices/lab_wire.sym} 620 -320 0 0 {name=p3 sig_type=std_logic lab=vdda}
C {devices/lab_wire.sym} 620 -100 0 0 {name=p5 sig_type=std_logic lab=vssa}
C {devices/lab_wire.sym} 780 -240 0 0 {name=p6 sig_type=std_logic lab=vout}
C {devices/vsource.sym} 280 -110 0 0 {name=V4
value="PULSE(0 3.3 50n 1p 1p 75n 150n)"
savecurrent=false}
...
C {libs/core_analog/asc_SR_latch/asc_SR_latch.sym} 620 -220 0 0 {}
