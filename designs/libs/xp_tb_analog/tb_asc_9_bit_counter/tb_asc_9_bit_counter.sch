...
value="PULSE(0 3.3 0 1p 1p 200n 300n)"
savecurrent=false}
...
value="PULSE(0 3.3 0 1p 1p 50n 1)"
savecurrent=false}
...
C {devices/lab_wire.sym} 700 -380 0 0 {name=p13 sig_type=std_logic lab=vdda}
C {devices/lab_wire.sym} 720 -400 0 0 {name=p14 sig_type=std_logic lab=vdda}
C {devices/lab_wire.sym} 740 -420 0 0 {name=p15 sig_type=std_logic lab=vdda}
C {devices/lab_wire.sym} 680 -360 0 0 {name=p16 sig_type=std_logic lab=vssa}
