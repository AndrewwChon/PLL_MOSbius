...
"}
C {devices/code_shown.sym} 580 -990 0 0 {name=Simulation only_toplevel=false value="
.control
.save v(fout)
set filetype=raw
tran 1n 50u
...
C {libs/core_analog/asc_FM_pulse_swallow_divider/asc_FM_pulse_swallow_divider.sym} 780 -500 0 0 {name=x1}
