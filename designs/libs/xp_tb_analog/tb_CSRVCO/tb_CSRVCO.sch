...
C {libs/core_analog/CSRVCO/CSRVCO.sym} 520 -220 0 0 {name=x1}
...
C {devices/vsource.sym} 160 -280 0 0 {name=V3 value=1 savecurrent=false}
...
C {devices/code_shown.sym} 60 -470 0 0 {name=Models only_toplevel=false
...
C {devices/code_shown.sym} 600 -470 0 0 {name=Simulation only_toplevel=false value="
.control
.save all
set filetype=raw
tran 1p 1u
