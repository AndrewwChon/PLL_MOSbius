...
N 600 -320 600 -280 {lab=vdda}
N 600 -160 600 -120 {lab=vssa}
N 730 -220 760 -220 {lab=vout}
N 480 -240 520 -240 {lab=va}
N 480 -200 520 -200 {lab=vb}
N 760 -220 780 -220 {lab=vout}
...
C {libs/core_analog/asc_NAND/asc_NAND.sym} 600 -220 0 0 {name=x1}
C {devices/lab_wire.sym} 600 -300 0 0 {name=p3 sig_type=std_logic lab=vdda}
C {devices/lab_wire.sym} 600 -120 0 0 {name=p5 sig_type=std_logic lab=vssa}
C {devices/lab_wire.sym} 780 -220 0 0 {name=p6 sig_type=std_logic lab=vout}
